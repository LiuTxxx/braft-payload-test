...
DEFINE_integer batch_size 400 'Batch size'
...
alias error=">&2 echo payload_test: "
...
raft_peers="10.0.0.246:8100:0,10.0.0.245:8100:0,"
...
for ((i=0; i<$FLAGS_server_num; ++i)); do
    mkdir -p runtime/$i
    cp ./payload_server runtime/$i
    cd runtime/$i
    ${VALGRIND} ./payload_server \
        ...
        -raft_leader_batch=${FLAGS_batch_size} \
